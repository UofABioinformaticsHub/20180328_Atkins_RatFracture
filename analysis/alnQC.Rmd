...
```{r plotLibSize, fig.height = 6, fig.width=8, fig.cap = "*Library sizes across all samples and groups. 3 saples fell below 10,000 reads which is the general minimum required for a confident analysis*"}
plotly::ggplotly(
  counts %>%
    colSums() %>%
    enframe(
